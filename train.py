...
if torch.cuda.is_available():
    try:
        ...
        print("CUDA available but not compatible, falling back to CPU")
...
def main(params):
    ...
    # Provide default values if parameters are not provided by NNI
    dropout = params.get('dropout', 0.3)
    subgraph_size = params.get('subgraph_size', 20)
    conv_channels = params.get('conv_channels', 32)
